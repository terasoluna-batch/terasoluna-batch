    ...
    public AbstractCollectorStubGetNext1() {
        ...
        this.queue = new BlockingQueue<DataValueObject>() {
            ...
            public DataValueObject peek() {
                ...
                queueCount.incrementAndGet();
                return new DataValueObject(new Exception("hoge1"));
            }

            public DataValueObject poll() {
                return new DataValueObject(new Exception("hoge2"));
            }
