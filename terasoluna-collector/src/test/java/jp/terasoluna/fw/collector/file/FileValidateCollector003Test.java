...
public class FileValidateCollector003Test extends DaoTestCase {
    /**
     * Log.
     */
    private static Log logger = LogFactory
            .getLog(FileValidateCollector003Test.class);
    ...
    public void testFileCollector003() throws Exception {
        ...
        ValidationErrorHandler validationErrorHandler = new SkipValidationErrorHandler();
