...
public class DaoValidateCollector006Test extends DaoTestCaseJunit4 {

    /**
     * Log.
     */
    private static Log logger = LogFactory.getLog(
            DaoValidateCollector006Test.class);
     ...
     */
    @Test
    public void testDaoValidateCollectorTestObjectStringObjectInt004() throws Exception {
        ...
        Collector<UserBean> it = new DaoValidateCollector<UserBean>(this.userListQueryResultHandleDao, "collect", null, 1, validator);
        try {
            while (it.hasNext()) {
                it.next();
                count_first++;
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Collector<UserBean> it2 = new DaoValidateCollector<UserBean>(this.userListQueryResultHandleDao, "collect", null, 1, validator);
            try {
