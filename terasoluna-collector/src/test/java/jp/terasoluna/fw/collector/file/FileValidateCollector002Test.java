...
public class FileValidateCollector002Test extends DaoTestCaseJunit4 {
    /**
     * Log.
     */
    private static Log logger = LogFactory.getLog(
            FileValidateCollector002Test.class);
    ...
    public void testFileCollector002() throws Exception {
        ...
        Collector<B000001Data> it = new FileValidateCollector<B000001Data>(this.csvFileQueryDAO, url
                .getPath(), B000001Data.class, exceptionHandler, validator);
