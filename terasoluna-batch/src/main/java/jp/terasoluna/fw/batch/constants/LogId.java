...
public final class LogId {
    ...
    /**
     * <strong>TAL025007 = Set MessageAccessor.{0}</strong>
     */
    public static final String TAL025007 = "TAL025007";
    /**
     * <strong>TAL025008 = Remove MessageAccessor.{0}</strong>
     */
    public static final String TAL025008 = "TAL025008";
    /**
     * <strong>DAL025017 = The exception was matched in exceptionToStatusMap. exception class name:{1} return status:{2}</strong>
     */
    ...
    /**
     * <strong>DAL025023 = Try to update status jobSequenceId:{0} changeStatus:{1}</strong>
     */
    public static final String DAL025023 = "DAL025023";
    /**
     * <strong>DAL025033 = Try to start transaction:{0}</strong>
     */
    ...
    /**
     * <strong>DAL025035 = Succeed to start transaction:{0}</strong>
     */
    public static final String DAL025035 = "DAL025035";
    /**
     * <strong>DAL025037 = Try to commit transaction:{0}</strong>
     */
    public static final String DAL025037 = "DAL025037";
    /**
     * <strong>DAL025038 = Succeed to commit transaction:{0}</strong>
     */
    public static final String DAL025038 = "DAL025038";
    /**
     * <strong>DAL025040 = Try to end transaction:{0}</strong>
     */
    public static final String DAL025040 = "DAL025040";
    /**
     * <strong>DAL025041 = Succeed to end transaction:{0}</strong>
     */
    ...
    /**
     * <strong>DAL025047 = Succeed to create savepoint:{0}</strong>
     */
    public static final String DAL025047 = "DAL025047";
    /**
     * <strong>DAL025048 = Try to release savepoint:{0}</strong>
     */
    public static final String DAL025048 = "DAL025048";
    /**
     * <strong>DAL025049 = Succeed to release savepoint:{0}</strong>
     */
    public static final String DAL025049 = "DAL025049";
    /**
     * <strong>DAL025050 = Try to rollback to savepoint:{0}</strong>
     */
    public static final String DAL025050 = "DAL025050";
    /**
     * <strong>DAL025051 = Succeed to rollback to savepoint:{0}</strong>
     */
    public static final String DAL025051 = "DAL025051";
    /**
     * <strong>DAL025052 = Try to rollback transaction:{0}</strong>
     */
    public static final String DAL025052 = "DAL025052";
    /**
     * <strong>DAL025053 = Succeed to rollback transaction:{0}</strong>
     */
    ...
    /**
     * <strong>IAL025020 = Waiting to shutdown all tasks in ThreadPoolTaskExecutor.</strong>
     */
    ...
    /**
     * <strong>WAL025010 = The BLogic execution continues without an ExceptionHandler.</strong>
     */
    public static final String WAL025010 = "WAL025010";
    /**
     * <strong>EAL025003 = Bean definition default file name is not set. please confirm batch.properties.</strong>
     */
    ...
    /**
     * <strong>EAL025045 = Failed to rollback transaction. {0}</strong>
     */
    public static final String EAL025045 = "EAL025045";
    /**
     * <strong>EAL025047 = This job cannot be accepted for execution. jobSequenceId:{0}</strong>
     */
    public static final String EAL025047 = "EAL025047";
    /**
     * <strong>EAL025048 = Failed to start transaction. {0}</strong>
     */
    public static final String EAL025048 = "EAL025048";
    /**
     * <strong>EAL025053 = An exception occurred. please see below the stacktrace.</strong>
     */
    public static final String EAL025053 = "EAL025053";
    /**
     * <strong>EAL025054 = When the job is waiting for a available worker thread, it has been interrupted. jobSequenceId:{0}</strong>
     */
    ...
    /**
     * <strong>EAL025056 = [Assertion failed] - {0} requires to set {1}. please confirm the settings.</strong>
     */
    public static final String EAL025056 = "EAL025056";
    /**
     * <strong>EAL025057 = An exception occurred at BLogic execution. This error log should be logged by the exception-handler, but the handler is not set.</strong>
     */
    ...
    /**
     * <strong>EAL025062 = Failed to close the ApplicationContext.</strong>
     */
