...
/**
 * {@link jp.terasoluna.fw.validation.springmodules.DefaultValidatorFactoryEx} クラスのブラックボックステスト。
 * <p>
 * <h4>【クラスの概要】</h4> FieldChecksクラスにて使用されるエラーインタフェースの実装に SpringフレームワークのErrorsクラスを扱うためのクラス。
 * <p>
...
public class DefaultValidatorFactoryExTest extends TestCase {
     ...
     * <br>
     * 引数beanNameが空文字であり、beanがnot nullであり、errorsが空のErrorsインスタンスの場合 <br>
     * @throws Exception このメソッドで発生した例外
     */
     ...
     * <br>
     * 引数beanNameが文字列であり、beanがnot nullであり、errorsが要素数1のErrorsインスタンスの場合 <br>
     * @throws Exception このメソッドで発生した例外
     */
     ...
     * validator.getFormName()="beanName"<br>
     * <br>
     * 引数beanNameが文字列であり、beanがnot nullであり、errorsが要素数3のErrorsインスタンスの場合 <br>
     * @throws Exception このメソッドで発生した例外
     */
