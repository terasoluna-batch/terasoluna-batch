...
public class FieldChecksTest10 extends TestCase {
     ...
     *
     * <br>
     * varのdatePatternに不正なパターン文字が含まれる場合、
     ...
     *
     * <br>
     * varのdatePatternStrictに不正なパターン文字が含まれる場合、
     * ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     ...
     *
     * <br>
     * varのdatePattern、datePatternStrictがnullの場合、
     * ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     ...
     *
     * <br>
     * varのdatePattern、datePatternStrictが空文字の場合、ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * beanが日付に変換できない場合、エラーを追加してfalseが返却されることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * startDateが日付に変換できない場合、ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * endDateが日付に変換できない場合、ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * beanの日付がendDateの日付以降の場合、エラーを追加してfalseが返却されることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * beanの日付とstartDate,endDateの日付が等しい場合、trueが返却されることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * beanの日付とdatePatternStrictのパターンの文字数が等しくない場合、
     * エラーを追加してfalseが返却されることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     ...
     * <br>
     * 期待値：(状態変化) 例外:ValidatorException<br>
     *                    メッセージ："Mistake on validation rule file. 
     ...
     *
     * <br>
     * vaからmethodParamsが取得できない場合、ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * vaに設定されたnameのメソッドが存在しない場合、ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *                   "a", "b", "c"<br>
     *                 };<br>
     *         (引数) va:methodParams="java.lang.Object,
     ...
     *
     * <br>
     * varのプロパティで指定されたフィールドが配列型のフィールドで、
     ...
     *
     * <br>
     * varのプロパティで指定されたフィールドがCollection型のフィールドで、
     * vaのnameで指定されたチェックの違反が複数存在する場合、
     * その回数分errorsのaddErrorsが呼び出されることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * varのプロパティで指定されたフィールドがプリミティブ配列型のフィールドで、
     * vaのnameで指定されたチェックの違反が複数存在する場合、
     * その回数分errorsのaddErrorsが呼び出されることを確認する。
     * <br>
     *
     ...
     *
     * <br>
     * varのプロパティで指定されたフィールドが配列、Collection型ではない場合、
     * そのフィールドに対してのチェックが行われることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
     ...
     *
     * <br>
     * 処理中にValidatorException、InvocationTargetException以外の例外が発生した場合、
     * ValidatorExceptionが発生することを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     ...
     *
     * <br>
     * 処理中にValidatorExceptionをラップしたInvocationTargetExceptionが発生した場合、
     ...
     *
     * <br>
     * 処理中にValidatorException以外の例外をラップした
     * InvocationTargetExceptionが発生した場合、
     * ラップした例外のメッセージを保持したValidatorExceptionがスローされることを確認する。
     * <br>
     *
     * @throws Exception このメソッドで発生した例外
     */
