...
public class StringUtil {
     ...
     *
     * <p>
     *     <b>※注意</b> 本メソッドではLIKE述語のエスケープ対象文字列として
     *     全角'％'、'＿'をエスケープ対象に含めている。<br>
     *     DB2、Oracle 11gR2(11.2.0.3)以降等、一部のRDBMSでは
     *     これら全角文字に対し通常文字として扱われるため、本メソッドによる
     *     エスケープにより誤動作の原因となる。<br>
     *     事前に利用対象のRDBMSでLIKE述語内の全角'％'、'＿'が
     *     エスケープ対象文字として適切であるか確認の上、本メソッドを使用すること。
     * </p>
     *
