 ...
 * </p>
 * <p>
 * <u>１．コンストラクタでアクセス対象のJavaBeanをラップする。</u>
 * 
 * <pre>
 ...
 * </p>
 * <p>
 * <u>２．firstName属性にアクセスする。</u> 引数のStringには属性名を指定する。
 * 
 * <pre>
 ...
 * </p>
 * <p>
 * <u>２．numbers属性にアクセスする。</u> <em>'numbers[]'のように配列記号を付ける必要はなく、
 ...
 * </p>
 * <p>
 * <u>２．EmployeeオブジェクトのhomeAddress属性にネストされた、 streetNumber属性にアクセスする。</u> ネストした属性を指定する場合、以下のコードのように'.'（ドット）で 属性名を連結する。
 * 
 * <pre>
 * Map&lt;String, Object&gt; map = bw.getIndexedPropertyValues(
 ...
 * </p>
 * <p>
 * <u>２．EmployeeのaddressMap属性中にセットしたhomeキーにアクセスする。</u> Map型属性のキーを指定する場合、以下のコードのようにかっこでキー名を連結する。
 * 
 * <pre>
 * Map&lt;String, Object&gt; map = bw.getIndexedPropertyValues(
 ...
 * <p>
 * <u>１．コンストラクタでアクセス対象のMapをラップする。</u>
 * 
 * <pre>
 * // Employeeの属性となるMap
 * Map addressMap = new HashMap();
 ...
 * </p>
 * <p>
 * <u>２．addressMapにセットしたhomeキーにアクセスする。</u>
 * 
 * <pre>
 * Map&lt;String, Object&gt; map = bw.getIndexedPropertyValues(
 *         "<strong>home</strong>");
 ...
 * <p>
 * <u>１．コンストラクタでアクセス対象のDynaBeanをラップする。</u>
 * 
 * <pre>
 ...
 * </p>
 * <p>
 * <u>２．DynaBeanのstreetNumber属性にアクセスする。</u>
 * 
 * <pre>
 * Map&lt;String, Object&gt; map = bw.getIndexedPropertyValues(
