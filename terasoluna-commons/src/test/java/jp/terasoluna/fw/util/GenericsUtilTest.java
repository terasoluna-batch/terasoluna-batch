 ...
 * <p>
 * <h4>【クラスの概要】</h4> <code>Generics</code>を扱うためのユーティリティクラス。
 * <p>
...
public class GenericsUtilTest {
    ...
    /**
     * testResolveParameterizedClassClassClass01() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     ...
     * <br>
     * 引数genericClassがnullの場合にIllegalArgumentExceptionが スローされることを確認するテスト。 <br>
    ...
    public void testResolveParameterizedClassClassClass01() throws Exception {
        ...
        try {
            ...
            // 判定
            assertEquals("Argument 'genericsClass' (" + Class.class.getName()
    ...
    /**
     * testResolveParameterizedClassClassClass02() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     ...
     * + Class.class.getName() + ") is null"<br>
     * <br>
     * 引数descendantClassがnullの場合にIllegalArgumentExceptionが スローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveParameterizedClassClassClass02() throws Exception {
        try {
            ...
            // 判定
            assertEquals("Argument 'descendantClass'(" + Class.class.getName()
                    + ") is null", e.getMessage());
            assertEquals(IllegalArgumentException.class.getName(), e.getClass()
                    .getName());
        }
    ...
    /**
     * testResolveParameterizedClassClassClass03() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     ...
     * <br>
     * 引数genericClass型パラメータ宣言を持たない親クラスである場合に、 IllegalStateExceptionがスローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass04() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つ親クラス<br>
     * (引数) descendantClass:genericClassの子クラス (型パラメータの具体クラスを指定していない)<br>
     * <br>
     * 期待値：(状態変化) 例外:IllegalStateException<br>
     * <br>
     * 型パラメータに具体クラスが指定されていない場合に、 IllegalStateExceptionがスローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveParameterizedClassClassClass04() throws Exception {
        try {
            // テスト実施
            GenericsUtil.resolveParameterizedClass(FutureTask.class,
                    GenericsUtil_FutureTaskStub01.class);
            fail("例外がスローされませんでした。");
        } catch (IllegalStateException e) {
            // 判定
            assertEquals(IllegalStateException.class.getName(), e.getClass()
    ...
    /**
     * testResolveParameterizedClassClassClass05() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つ親クラス<br>
     * (引数) descendantClass:genericClassの子クラス (型パラメータの具体クラスにStringを指定)<br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = String.class<br>
     * <br>
     * descendantClassが子クラスである場合に、 型パラメータの具体クラスが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass06() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つ親クラス<br>
     * (引数) descendantClass:genericClassの孫クラス (型パラメータの具体クラスにMap<String, Object>を指定)<br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = Map.class<br>
     * <br>
     * descendantClassが孫クラスである場合に、型パラメータの具体クラスが 取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass07() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親クラス<br>
     * (引数) descendantClass:genericClassの子クラス (型パラメータの具体クラスにString[], Integer, Booleanを指定)<br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = String[].class<br>
     * 要素1 = Integer.class<br>
     * 要素2 = Boolean.class<br>
     * <br>
     * 型パラメータが複数の場合に、型パラメータの具体クラスが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass08() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親インタフェース<br>
     * (引数) descendantClass:genericClassの実装クラス (型パラメータの具体クラスにString[], Integer, Booleanを指定)<br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = String[].class<br>
     * 要素1 = Integer.class<br>
     * 要素2 = Boolean.class<br>
     * <br>
     * 型パラメータ宣言がインタフェースで行われている場合に、型パラメータの具体クラスが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass09() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親インタフェース<br>
     * (引数) descendantClass:genericClassの継承インタフェースの実装クラス (型パラメータの具体クラスにString[], Integer, Booleanを指定)<br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = String[].class<br>
     * 要素1 = Integer.class<br>
     * 要素2 = Boolean.class<br>
     * <br>
     * 型パラメータ宣言がインタフェースで行われており、インタフェースが継承されている場合に、 型パラメータの具体クラスが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass10() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親インタフェース<br>
     * (引数) descendantClass:genericClassの継承インタフェースの実装クラスのサブクラス (型パラメータは実装クラスで指定) (型パラメータの具体クラスにString[], Integer, Booleanを指定)
     * <br>
     * <br>
     * 期待値：(戻り値) Class[]:要素0 = String[].class<br>
     * 要素1 = Integer.class<br>
     * 要素2 = Boolean.class<br>
     * <br>
     * 型パラメータ宣言がインタフェースで行われており、インタフェースが継承され、 かつ、実装クラスが継承されている場合に、 型パラメータの具体クラスが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClass11() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親インタフェース<br>
     * (引数) descendantClass:genericClassの継承インタフェースの実装クラスのサブクラス (型パラメータはサブクラスで指定) (型パラメータの具体クラスにString[], Integer, Booleanを指定)
     * <br>
     * <br>
     * 期待値：(戻り値) Class[]: 要素0 = Boolean.class<br>
     * 要素1 = String[].class<br>
     * 要素2 = Integer.class<br>
     * <br>
     * 型パラメータ宣言がインタフェースで行われており、インタフェースが継承され、 かつ、実装クラスが継承されている場合に、 型パラメータの具体クラスが取得できることを確認するテスト。
     * 型パラメータの宣言順が入れ替えられていた場合でも正しく取得できることの テストを包含する。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveParameterizedClassClassClassint01() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint02() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint03() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint04() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
    ...
    public void testResolveParameterizedClassClassClassint04() throws Exception {
        try {
            // テスト実施
            GenericsUtil.resolveParameterizedClass(FutureTask.class,
                    GenericsUtil_FutureTaskStub01.class, 0);
            fail("例外がスローされませんでした。");
        } catch (IllegalStateException e) {
            // 判定
            assertEquals(IllegalStateException.class.getName(), e.getClass()
    ...
    /**
     * testResolveParameterizedClassClassClassint05() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint06() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint07() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     ...
     * <br>
     * 期待値：(状態変化) 例外:IllegalArgumentException<br>
     * メッセージ："Argument 'index'(-1) is out of bounds of generics parameters"<br>
     * <br>
     * 引数indexが負の数である場合に、IllegalArgumentExceptionが スローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveParameterizedClassClassClassint07() throws Exception {
        try {
            // テスト実施
            GenericsUtil.resolveParameterizedClass(FutureTask.class,
                    GenericsUtil_FutureTaskStub02.class, -1);
        } catch (IllegalArgumentException e) {
            // 判定
            assertEquals("Argument 'index'(-1) is out of bounds of "
                    + "generics parameters", e.getMessage());
            assertEquals(IllegalArgumentException.class.getName(), e.getClass()
                    .getName());
        }
    }
    ...
    /**
     * testResolveParameterizedClassClassClassint08() <br>
     * <br>
     * (異常系) <br>
     * 観点：G <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つ親クラス<br>
     * (引数) descendantClass:genericClassの孫クラス (型パラメータの具体クラスにIntegerを指定)<br>
     * (引数) index:1<br>
     * <br>
     * 期待値：(状態変化) 例外:IllegalArgumentException<br>
     * メッセージ："Argument 'index'(1) is out of bounds of generics parameters"<br>
     * <br>
     * 引数indexがパラメータ数より多い場合に、IllegalArgumentExceptionが スローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveParameterizedClassClassClassint08() throws Exception {
        try {
            // テスト実施
            GenericsUtil.resolveParameterizedClass(FutureTask.class,
                    GenericsUtil_FutureTaskStub03.class, 1);
        } catch (IllegalArgumentException e) {
            // 判定
            assertEquals("Argument 'index'(1) is out of bounds of "
                    + "generics parameters", e.getMessage());
    ...
    /**
     * testResolveParameterizedClassClassClassint09() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint10() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint11() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
    ...
    /**
     * testResolveParameterizedClassClassClassint12() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を3つ持つ親インタフェース<br>
     * (引数) descendantClass:genericClassの継承インタフェースの実装クラスのサブクラス (型パラメータの具体クラスにString[], Integer, Booleanを指定)<br>
     * (引数) index:1<br>
     * <br>
     * 期待値：(戻り値) Class:Integer.class<br>
     * <br>
    ...
    public void testGetAncestorTypeList01() throws Exception {
        try {
            ...
            // 判定
            assertEquals("Argument 'genericClass'(" + Object.class.getName()
                    + ") does not declare type parameter", e.getMessage());
            assertEquals(IllegalStateException.class.getName(), e.getClass()
                    .getName());
        }
    }
     ...
     * <br>
     * 1世代継承している場合に、ParameterizedTypeのリストが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * ParameterizedType<br>
     * <br>
     * 複数世代継承している場合に、ParameterizedTypeのリストが取得できることを 確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetAncestorTypeList03() throws Exception {
        ...
        assertEquals(getParameterizedClassList(FutureTask.class,
                GenericsUtil_FutureTaskStub03.class), result);
    }

    /**
     * testGetAncestorTypeList04() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つインタフェース<br>
     * (引数) descendantClass:genericClassの実装クラス (型パラメータの具体クラスにIntegerを指定)<br>
     * <br>
     * 期待値：(戻り値) List<ParameterizedType>:要素0 = genericClassの<br>
     * ParameterizedType<br>
     * <br>
     * インタフェースを１つ実装している場合に、ParameterizedTypeのリストが 取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetAncestorTypeList04() throws Exception {
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals(GenericsUtil_CallableStub01.class
                .getGenericInterfaces()[0], result.get(0));
    }

    /**
     * testGetAncestorTypeList05() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:型パラメータ宣言を1つ持つインタフェース<br>
     * (引数) descendantClass:genericClassの実装クラスの子クラス (型パラメータの具体クラスにIntegerを指定、 また、Comparable<T>, Comparator<T>を実装)<br>
     * <br>
     * 期待値：(戻り値) List<ParameterizedType>:要素0 = genericClassの<br>
     * ParameterizedType<br>
     * <br>
     * インタフェースを複数実装している場合に、ParameterizedTypeのリストが 取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetAncestorTypeList05() throws Exception {
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals(GenericsUtil_CallableStub02.class
                .getGenericInterfaces()[0], result.get(0));
    }

    /**
     * testGetAncestorTypeList06() <br>
     * <br>
     * (正常系) <br>
     * 観点：E <br>
     * <br>
     * 入力値：(引数) genericClass:Comparable.class<br>
     * (引数) descendantClass:Callableの実装クラスの子クラス (型パラメータの具体クラスにIntegerを指定、 また、Comparable<T>, Comparator<T>を実装)<br>
     * <br>
     ...
     * ParameterizedType<br>
     * <br>
     * インタフェースを複数実装しており、かつ、複数世代で実装されている場合に、 ParameterizedTypeのリストが取得できることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetAncestorTypeList06() throws Exception {
        ...
        assertNotNull(result);
        assertEquals(1, result.size());
        assertEquals(GenericsUtil_CallableStub03.class
                .getGenericInterfaces()[0], result.get(0));
    }

    /**
     * testCheckParameterizedType01() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     ...
     * <br>
     * typeがParameterizedTypeではない場合に、リストに何も追加されず falseが返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testCheckParameterizedType01() throws Exception {
        ...
        // テスト実施
        boolean result = GenericsUtil.checkParameterizedType(ArrayList.class,
                List.class, list);
    ...
    /**
     * testCheckParameterizedType02() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     * 入力値：(引数) type:ArrayList継承クラスについて、 ArrayList<E>のgetParameterizedType()<br>
     ...
     * (状態変化) ancestorTypeList:変化なし<br>
     * <br>
     * typeがgenericClassの子クラスではない場合に、 リストに何も追加されずfalseが返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testCheckParameterizedType03() <br>
     * <br>
     * (正常系) <br>
     * 観点：C, E <br>
     * <br>
     ...
     * <br>
     * 期待値：(戻り値) boolean:false<br>
     * (状態変化) ancestorTypeList: 要素0 = ArrayList<E>のgetParameterizedType()<br>
     * <br>
     * typeの実際のクラスがgenericClassと同一ではない場合に、リストに追加され、 falseが返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testCheckParameterizedType03() throws Exception {
        ...
        assertEquals(GenericsUtil_ArrayListStub01.class.getGenericSuperclass(),
                list.get(0));
    }

    /**
     * testCheckParameterizedType04() <br>
     * <br>
     * (正常系) <br>
     * 観点：C, E <br>
     * <br>
     * 入力値：(引数) type:ArrayList継承クラスについて、 List<E>のgetParameterizedType()<br>
     * (引数) genericClass:List.class<br>
     * (引数) ancestorTypeList:空のArrayList<ParameterizedType><br>
     * <br>
     ...
     * <br>
     * typeの実際のクラスがgenericClassと同一である場合に、リストに追加され、 trueが返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testCheckParameterizedType04() throws Exception {
        ...
        // テスト実施
        boolean result = GenericsUtil.checkParameterizedType(type, List.class,
                list);
     ...
     * 期待値：(戻り値) Class:String.class<br>
     * <br>
     * typeがClass型である場合に、typeがそのまま返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveTypeVariable01() throws Exception {
        ...
        // テスト実施
        Class<?> result = GenericsUtil.resolveTypeVariable(stringClass,
     ...
     * <br>
     * 期待値：(状態変化) 例外:IllegalStateException<br>
     * メッセージ："Concrete type of Type(E) was not found in ancestorList("<br>
     * + ancestorTypeList + ")"<br>
     * <br>
     * ancestorTypeList中にtypeに関連する親がない場合、 IllegalStateExceptionがスローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveTypeVariable02() throws Exception {
        // 前処理
        Type type = getTypeVariable(AbstractList.class,
        ...
        try {
            ...
            // 判定
            assertEquals("Concrete type of Type(" + type
                    + ") was not found in ancestorList(" + list + ")", e
                            .getMessage());
            assertEquals(IllegalStateException.class.getName(), e.getClass()
                    .getName());
        }
     ...
     * 期待値：(状態変化) 例外:IllegalStateException<br>
     * <br>
     * isClassOrTypeVariableでIllegalStateExceptionがスローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * 内容は、ArrayList継承クラス<String>の 親クラスのParameterizedTypeの全て<br>
     * <br>
     * 期待値：(状態変化) 例外:IllegalStateException<br>
     * メッセージ："TypeVariable("<br>
     * + targetType.getName() + " is not declared at Class "<br>
     * + "(ie. is declared at Method or Constructor)")<br>
     * <br>
     * typeがクラスで宣言されていない場合、IllegalStateExceptionが スローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveTypeVariable04() throws Exception {
        // 前処理
        Method emptyListMethod = Collections.class.getMethod("emptyList",
                new Class[0]);
        TypeVariable<?> type = emptyListMethod.getTypeParameters()[0];

        List<ParameterizedType> list = getParameterizedClassList(List.class,
                GenericsUtil_ArrayListStub01.class);
        ...
        try {
            ...
            // 判定
            assertEquals("TypeVariable(" + type.getName()
                    + " is not declared at Class "
                    + "(ie. is declared at Method or Constructor)", e
                            .getMessage());
            assertEquals(IllegalStateException.class.getName(), e.getClass()
                    .getName());
        }
     ...
     * 入力値：(引数) type:ArrayList継承クラス<String>のList<E>について型変数E<br>
     * (引数) ancestorTypeList:ArrayList<ParameterizedType><br>
     * 内容は、ArrayList継承クラス<String>の親クラスの ParameterizedTypeの全てに加え、 ComparatorのParameterizedType<br>
     * <br>
     * 期待値：(戻り値) Class:Map.class<br>
     * <br>
     * 型変数宣言が1つの場合、指定した型変数の実際の型が返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testResolveTypeVariable06() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     * 入力値：(引数) type:HashMap継承クラス<String, Integer>( KとVの順番を入れ替えること)の Map<K, V>について型変数V<br>
     * (引数) ancestorTypeList:ArrayList<ParameterizedType><br>
     * 内容は、HashMap継承クラス<String, Integer>の 親クラスのParameterizedTypeの全て。<br>
     * <br>
     * 期待値：(戻り値) Class:Integer.class<br>
     * <br>
     * 型変数宣言が複数の場合、指定した型変数の実際の型が返却されることのテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testResolveTypeVariable06() throws Exception {
        // 前処理
        Type type = getTypeVariable(HashMap.class,
                GenericsUtil_HashMapStub02.class, 1);

        List<ParameterizedType> list = getParameterizedClassList(Map.class,
                GenericsUtil_HashMapStub02.class);
     ...
     * 期待値：(戻り値) boolean:true<br>
     * <br>
     * typeがClassである場合に、trueが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * 期待値：(戻り値) boolean:false<br>
     * <br>
     * typeがTypeValiableである場合に、falseが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * <br>
     * typeがClassでもTypeValiableでもない場合、IllegalStateExceptionが スローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testIsNotTypeVariable03() throws Exception {
        ...
        try {
            ...
            // 判定
            assertEquals("Type(" + type + ") is not instance of "
                    + TypeVariable.class.getName() + ", "
                    + ParameterizedType.class.getName() + ", "
                    + GenericArrayType.class.getName() + " nor " + Class.class
    ...
    /**
     * testIsNotTypeVariable04() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     * 入力値：(引数) type:ArrayList継承クラスについて、 ArrayList<E>のParameterizedType()<br>
     * <br>
     * 期待値：(戻り値) boolean:true<br>
     * <br>
     * typeがParameterizedTypeである場合に、trueが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * 期待値：(戻り値) boolean:true<br>
     * <br>
     * typeがGenericArrayTypeである場合に、trueが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * <code>startClass</code>から<code>endClass</code>までの 継承関係にある、<code>ParameterizedType</code>をリストにして 返却する。
     * @param <T> クラス。
    ...
    private <T> Type getTypeVariable(Class<T> firstImplementation,
        ...
        ParameterizedType parameterizedClass = (ParameterizedType) clazz
    ...
    private <T> Type getTypeArgument(Class<T> clazz, int index) {
        ...
        Type argument = ((ParameterizedType) type)
                .getActualTypeArguments()[index];
        return argument;
    }

    /**
     * testGetRawClass01() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     ...
     * 期待値：(戻り値) Class:String.class<br>
     * <br>
     * typeがClassである場合に、そのまま返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
     ...
     * 期待値：(戻り値) Class:Map.class<br>
     * <br>
     * typeがParameterizedTypeである場合に、その元となるクラスが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetRawClass02() throws Exception {
        // 前処理
        Type type = getTypeArgument(GenericsUtil_ArrayListStub01.class, 0);
     ...
     * 期待値：(戻り値) Class:String[].class<br>
     * <br>
     * typeがGenericArrayTypeである場合に、その元となる配列クラスが返却されることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    public void testGetRawClass03() throws Exception {
        // 前処理
        Type type = getTypeArgument(GenericsUtil_ArrayListStub02.class, 0);
     ...
     * + Class.class.getName()<br>
     * <br>
     * typeがClassでもTypeValiableでもない場合、IllegalStateExceptionがスローされることを確認するテスト。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
    ...
    /**
     * testGetRawClass05() <br>
     * <br>
     * (正常系) <br>
     * 観点：C <br>
     * <br>
     * 入力値：(引数) type:GenericArrayTypeインスタンス （getGenericComponentTypeの戻り値:GenericArrayTypeインスタンス
     * (getGenericComponentTypeの戻り値:String.class)）<br>
     * <br>
     * 期待値：(戻り値) Class:String[].class<br>
     * <br>
     * typeがGenericArrayTypeでかつ、getGenericComponentClassの戻り値が GenericArrayTypeである場合に、正常に動作しないこと
     * （そのgetGenericComponentClassの2元配列が取得される）を確認するテスト。 ※現状のJDKでは、このような事態は発生しない。 <br>
     * @throws Exception このメソッドで発生した例外
     */
    @Test
