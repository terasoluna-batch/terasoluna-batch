...
public class DataSourceMessageSourceTest {
    ...
    public void testReadMessageFromDataSource02() throws Exception {
        ...
        DBMessage db1 = new DBMessage("test01", "JP", "ja", "kaisai", "テストメッセージ０１");
        list.add(db1);
        dbmr.list = list;
    ...
    public void testReadMessageFromDataSource03() throws Exception {
        ...
        List<DBMessage> list = new ArrayList<DBMessage>();
        DBMessage db1 = new DBMessage("test01", "JP", "ja", "kaisai", "テストメッセージ０１");
        DBMessage db2 = new DBMessage("test02", "JP", "ja", "kaisai", "テストメッセージ０２");
        DBMessage db3 = new DBMessage("test03", "JP", "ja", "kaisai", "テストメッセージ０３");
        list.add(db1);
        list.add(db2);
        list.add(db3);
        dbmr.list = list;
    ...
    public void testCreateLocale01() throws Exception {
        // 前処理
        DataSourceMessageSource ds = new DataSourceMessageSource();
        DBMessage message = new DBMessage("test01", null, null, null, "テストメッセージ０１");
    ...
    public void testCreateLocale03() throws Exception {
        // 前処理
        DataSourceMessageSource ds = new DataSourceMessageSource();
        DBMessage message = new DBMessage("test01", "ja", null, null, "テストメッセージ０１");
        ds.defaultLocale = null;
    ...
    public void testCreateLocale04() throws Exception {
        // 前処理
        DataSourceMessageSource ds = new DataSourceMessageSource();
        DBMessage message = new DBMessage("test01", "ja", "JP", null, "テストメッセージ０１");
        ds.defaultLocale = null;
    ...
    public void testCreateLocale05() throws Exception {
        // 前処理
        DataSourceMessageSource ds = new DataSourceMessageSource();
        DBMessage message = new DBMessage("test01", "ja", "JP", "kansai", "テストメッセージ０１");
        ds.defaultLocale = null;
