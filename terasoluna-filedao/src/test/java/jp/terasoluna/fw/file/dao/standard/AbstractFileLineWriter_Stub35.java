 ...
 * > columnIndex：1<br>
 * > bytes：48<br>
 * > stringConverter：以下の処理を持つStringConverterのクラスインスタンス - 入力されたデータに"_convert()"を追加した結果を返す。 > その他項目：デフォルト値</li>
 * </ul>
 * <ul>
 ...
 */
@FileFormat()
public class AbstractFileLineWriter_Stub35 {
     ...
     * column2
     */
    @OutputFileColumn(columnIndex = 1, bytes = 48, stringConverter = AbstractFileLineWriter_StringConverterStub03.class)
