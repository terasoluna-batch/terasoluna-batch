 ...
 */
public class NullStringConverterTest extends TestCase {
    ...
    public static void main(String[] args) {
        // junit.swingui.TestRunner.run(NullStringConverterTest.class);
    }
     ...
     */
    public NullStringConverterTest(String name) {
        super(name);
    }
