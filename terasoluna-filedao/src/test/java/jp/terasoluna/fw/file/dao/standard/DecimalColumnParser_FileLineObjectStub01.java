...
public class DecimalColumnParser_FileLineObjectStub01 {
    ...
    private BigDecimal decimal10 = null;

    private BigDecimal decimal11 = null;

    /**
     * publicで引数ありの正常のsetterメソッド
    ...
    public void setDecimal06(BigDecimal decimal061, BigDecimal decimal062) {
        ...
        this.decimal06 = decimal062;
    }

    /**
     * publicで引数がありの異常のsetterメソッド
    ...
    /**
     * publicで引数がありの異常のsetterメソッド
     * @param decimal10 設定する decimal10
     */
    ...
    /**
     * publicで引数がありの異常のsetterメソッド
     * @param decimal11 設定する decimal11
     */
